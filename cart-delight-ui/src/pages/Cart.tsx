...
const initialItems: CartItem[] = [
  ...
  {
    id: 2,
    name: "Pearl Embellished Kurti Set",
    ...
    originalPrice: 2999,
    quantity: 1,
    image: "https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?w=200&h=260&fit=crop",
  },
  {
    id: 3,
    ...
    originalPrice: 2499,
    quantity: 2,
    image: "https://images.unsplash.com/photo-1542272604-787c3835535d?w=200&h=260&fit=crop",
  },
];
  ...
  return (
    <div className="min-h-screen bg-secondary">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <p className="text-sm text-muted-foreground mb-6">{items.length} item{items.length !== 1 ? "s" : ""} in your bag</p>
              ...
              {items.map((item) => (
                <div key={item.id} className="bg-card rounded-xl p-4 flex gap-4 relative border border-border">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">{item.brand}</p>
                    <h3 className="font-semibold text-foreground mt-0.5 truncate">{item.name}</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-card rounded-xl p-5 border border-border">
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <Button variant="coral" size="sm">Apply</Button>
                </div>
              </div>
              ...
              <div className="bg-card rounded-xl p-5 border border-border">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-foreground">₹{totalOriginal.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <p className="text-xs text-primary font-medium">You save ₹{discount.toLocaleString()} on this order!</p>
                </div>
              ...
              <div className="bg-card rounded-xl p-5 border border-border grid grid-cols-3 gap-3 text-center">
                <div className="flex flex-col items-center gap-1.5">
                  ...
                  <span className="text-[11px] text-muted-foreground leading-tight">Free Shipping<br />above ₹999</span>
                </div>
                <div className="flex flex-col items-center gap-1.5">
                  <ShieldCheck className="h-5 w-5 text-primary" />
                  <span className="text-[11px] text-muted-foreground leading-tight">Secure<br />Payment</span>
                </div>
                <div className="flex flex-col items-center gap-1.5">
